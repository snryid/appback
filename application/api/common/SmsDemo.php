...
require_once ROOT_PATH . 'extend' . DS . '/SendSms/vendor/autoload.php';
...
class SmsDemo
{
    ...
    public static function getAcsClient()
    {
        ...
        $accessKeyId = "LTAI1izKvRCM0phu"; // AccessKeyId

        $accessKeySecret = "AQgd35hjEXc6FJnn1k9tiycR47PoXs"; // AccessKeySecret
