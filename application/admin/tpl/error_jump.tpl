...
<head>
    ...
    <style type="text/css">
        *{ padding: 0; margin: 0; }
        body{ background: #eee; font-family: "Microsoft Yahei","Helvetica Neue",Helvetica,Arial,sans-serif; color: #333; font-size: 16px; }
        ...
        .system-message .success,.system-message .error{ line-height: 1.8em; font-size: 36px; display: none;}
